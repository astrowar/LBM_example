...
void showGraphics(int WIDTH, int HEIGHT, double xmin, double xmax, double ymin, double ymax, const double* ux, const double* uy)
{
    //--------------------------------
    ...
    const int NX = WIDTH/8;
    const int NY = HEIGHT/8;
...
int main(int argc, char* argv[])
{
    ...
    double* f = new double[N * N * Qcc];
    double* feq = new double[N * N * Qcc];
    double* f_new = new double[N * N * Qcc];
    ...
    // D3Q9 parameters
    double* ex = new double[Qcc];
    double* ey = new double[Qcc];
    int* oppos = new int[Qcc];
    double* wt = new double[Qcc];
